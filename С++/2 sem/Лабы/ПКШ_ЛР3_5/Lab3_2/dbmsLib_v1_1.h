...
class DBTableTxt{
  	...
  	public:
		...
		friend void ReadDBTable11(DBTableTxt& tab,string fileName);//fileName=path+tableName
		friend void PrintTable11(DBTableTxt& tab,int screenWidth);//fileName=path+tableName
		friend void WriteDBTable11(DBTableTxt&,string fileName);//fileName=path+tableName
