...
private:
	...
	string fileName;
  	public:
		...
		//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
		friend void CreateTableMaket1(DBTableTxt& tab,Strip* &strips,int &nStrips,int screenWidth);
		friend string valueToString1(DBTableTxt& tab,Row& row,string columnName);
	};
//=====================Класс DBTableBin=====================================
...
public: 
	...
	friend void ReadDB7(DBTableSet& tab);
	friend void PrintDB7(DBTableSet& tab, int screenWidth);
	friend void WriteDB7(DBTableSet& tab);
