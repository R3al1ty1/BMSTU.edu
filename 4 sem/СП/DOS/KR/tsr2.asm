...
;
; Авторы:
;  МГТУ им. Н. Э. Баумана, ИУ5-45Б, 2023 г.
;	Коновалов И.Н.
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
code segment	'code'
	...
	;@Если по варианту нужно, чтобы происходила замена символов
	; данные
	ignoredChars 					DB	'абвгдеёжзийклмнопрстуфхцчшщъыьэюя'	; список игнорируемых символов
	replaceWith 					DB	'АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЬЭЮЯ'	; список заменяемых символов
	ignoredLength 				equ	$-ignoredChars				; длина строки ignoredChars
	ignoreEnabled 				DB	0							; флаг функции игнорирования ввода
	translateFrom 				DB	'KVYJG'						; символы для замены
	...
	cursiveSymbol 						DB 00111111b						;@ символ, составленный из единичек (его курсивный вариант)
								DB 00100001b
								DB 00100010b
								DB 00100100b
								DB 01111000b
	...
	signatureLine1				DB	179, 'Коновалов Илья Николаевич                        ', 179
	Line1_length 					equ	$-signatureLine1
	signatureLine2				DB	179, 'ИУ5-45                                            ', 179
	Line2_length 					equ	$-signatureLine2
	signatureLine3				DB	179, 'Вариант #7                                        ', 179
	...
	helpMsg DB '>tsr.com [/?]', 10, 13
			...
			DB '  F4  - включение и отключения курсивного вывода русского символа В', 10, 13
			DB '  F5  - включение и отключение частичной русификации клавиатуры(KVYJG -> ЛМНОП)', 10, 13
			DB '  F6  - включение и отключение режима перевода строчных на прописные', 10, 13
